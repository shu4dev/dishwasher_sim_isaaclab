...
Usage:
    /workspace/isaaclab/isaaclab.sh -p scripts/00_inspect_scene.py --headless
...
def main():
    ...
    lines = ["# Joint report", ""]
    lines.append(f"Generated by `scripts/00_inspect_scene.py` (variant `{args_cli.dishwasher}`, mode: {mode}).")
