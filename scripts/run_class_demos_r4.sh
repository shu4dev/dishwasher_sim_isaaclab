#!/usr/bin/env bash
# Round-4 per-class driver: apertures frozen (data-derived), weld-carried families start
...
declare -A STAGES=( [plate]="12 13 15 20" [bowl]="12 13 15 20" [cup]="12 13 15 20" [fork]="15 20" )
