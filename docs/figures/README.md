...
| `bosch800_loaded_top.png` | produced by the retired robot episode runner (git history, `run_task.py`, run `bosch_sanity_load2`); a physically-settled full-load top view — regenerate the equivalent via `capacity_fill.py` / `reveal_render.py` | `media/task/bosch_sanity_load2/ep002_final_top.png` |
