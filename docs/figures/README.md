...
| `object_library.png` | `scripts/run_kit.sh scripts/setup/build_object_assets.py` | `media/assets/library_sheet.png` (sheet predates the pitcher class's retirement) |
