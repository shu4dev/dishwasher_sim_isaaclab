...
``scripts/setup/inspect_scene.py``); do not eyeball-edit them. Frame convention everywhere:
...
TASK: dict = {
    ...
    "rack_state": "placement",
    # Which camera the run MP4 is written from (see config.CAMERAS + EPISODE_CAMERA).
